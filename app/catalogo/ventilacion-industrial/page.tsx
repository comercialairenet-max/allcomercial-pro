...
export const metadata: Metadata = {
  ...
  description:
    "Soluciones de ventilación industrial para extracción de aire, renovación de ambientes y control térmico en procesos industriales. Consulta equipos y apoyo comercial en Colombia.",
  alternates: {
    canonical: "/catalogo/ventilacion-industrial",
  },
  openGraph: {
    title:
      "Ventilación industrial | Extractores, ventiladores y soluciones de aire",
    description:
      "Consulta soluciones de ventilación industrial para extracción, renovación de aire y aplicaciones técnicas en Colombia.",
    url: "/catalogo/ventilacion-industrial",
    type: "website",
  },
  twitter: {
    ...
    title:
      "Ventilación industrial | Extractores, ventiladores y soluciones de aire",
    description:
      "Portafolio técnico de ventilación industrial para extracción, movimiento y renovación de aire.",
  },
  keywords: [
    "ventilación industrial",
    "extractores industriales",
    "ventiladores industriales",
    "extractores axiales industriales",
    "extracción de aire industrial",
    "renovación de aire industrial",
    "ventilación industrial Colombia",
...
export default function VentilacionIndustrialPage() {
  const whatsappGeneralHref = getWhatsappUrl(
    "Hola, quiero información sobre soluciones de ventilación industrial."
  );

  const whatsappAplicacionHref = getWhatsappUrl(
    "Hola, quiero validar una aplicación de ventilación industrial para mi proceso."
  );

  const whatsappCotizacionHref = getWhatsappUrl(
    "Hola, quiero solicitar una cotización de productos de ventilación industrial."
  );

  const aplicaciones = [
    "Extracción de aire en talleres y áreas de trabajo",
    "Renovación de aire en bodegas y espacios industriales",
    "Control térmico y apoyo a procesos productivos",
    "Sistemas de ventilación para ambientes técnicos",
    "Apoyo a cabinas, cuartos técnicos y zonas de operación",
    "Movimiento de aire para mejorar condiciones operativas",
  ];

  const beneficios = [
    {
      title: "Mejor circulación y renovación de aire",
      text: "Una solución adecuada de ventilación ayuda a mejorar el movimiento del aire y a mantener ambientes más controlados.",
      icon: Wind,
    },
    {
      title: "Apoyo a la operación industrial",
      text: "La ventilación industrial puede contribuir al confort operativo, al control térmico y a la estabilidad del proceso.",
      icon: Factory,
    },
    {
      title: "Categoría útil para elegir mejor",
      text: "Esta sección ayuda a relacionar la necesidad con la línea correcta antes de llegar a una referencia específica.",
      icon: ShieldCheck,
    },
  ];
          ...
          <div className="grid gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
            <div className="max-w-2xl">
              ...
              <h1 className="mt-6 text-4xl font-black tracking-tight text-slate-950 md:text-5xl xl:text-6xl">
                Ventilación industrial para extracción, renovación y movimiento de aire
              </h1>

              <p className="mt-6 max-w-xl text-lg leading-8 text-slate-600">
                Esta categoría reúne soluciones de <strong>ventilación industrial</strong>
                orientadas a extracción de aire, renovación de ambientes,
                control térmico y apoyo a procesos donde el flujo de aire es
                clave para una operación más eficiente.
              </p>
              ...
              <div className="mt-10 grid gap-3 sm:grid-cols-2">
                {[
                  "Consulta por aplicación o necesidad operativa",
                  "Apoyo para validar la línea adecuada",
                  "Salida directa a cotización",
                  "Categoría orientada a consulta técnica",
                ].map((item) => (
                  <div
                    key={item}
                  ...
                  <div className="flex flex-col justify-between bg-[#F8FAFC] p-8 md:p-10">
                    <div>
                      ...
                      <p className="mt-4 text-sm leading-7 text-slate-600">
                        Cuando el cliente sabe que necesita ventilación o
                        extracción, esta sección ayuda a ubicar mejor la línea,
                        la aplicación y el siguiente paso comercial.
                      </p>
                    </div>
                    ...
                    <div className="grid gap-4">
                      <div className="rounded-[24px] border border-slate-200 bg-white p-5 shadow-sm">
                        ...
                        <p className="mt-2 text-lg font-bold text-slate-950">
                          Extracción, renovación y control de aire
                        </p>
                      </div>
                    ...
                    <div className="relative z-10 flex h-full flex-col justify-between">
                      <div>
                        ...
                        <h3 className="mt-6 text-3xl font-black leading-tight text-white">
                          Ventilación para ambientes técnicos e industriales
                        </h3>

                        <p className="mt-4 text-sm leading-7 text-white/90">
                          Útil para procesos donde la extracción, la renovación
                          del aire y el movimiento controlado del flujo son
          ...
          <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              ...
              <h2 className="mt-5 text-3xl font-extrabold text-slate-950 md:text-4xl">
                Ventilación industrial para procesos que requieren mejor control del aire
              </h2>

              <p className="mt-5 text-lg leading-8 text-slate-600">
                Las soluciones de <strong>ventilación industrial</strong> ayudan a
                mejorar el movimiento del aire, apoyar la extracción en áreas de
                trabajo y contribuir a condiciones operativas más adecuadas en
                talleres, bodegas y procesos productivos.
              </p>

              <p className="mt-4 text-base leading-8 text-slate-600">
                Esta categoría funciona como punto de entrada para clientes que
                buscan extractores industriales, ventiladores, soluciones de
                renovación de aire o apoyo técnico para una aplicación específica
      ...
      <section className="bg-[#F4F7FB] py-20">
        <div className="mx-auto max-w-7xl px-6 md:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-5 text-3xl font-extrabold text-slate-950 md:text-4xl">
              ¿Por qué empezar por ventilación industrial?
            </h2>
            <p className="mt-4 text-lg leading-8 text-slate-600">
              Esta categoría ayuda a ordenar mejor la consulta cuando la necesidad
              está relacionada con aire, extracción, temperatura o circulación controlada.
            </p>
          </div>
          ...
          <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr]">
            <div className="rounded-[30px] border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="mt-6 space-y-4">
                {[
                  "Empieza por la categoría si ya sabes que necesitas ventilación o extracción.",
        ...
        <div className="mx-auto max-w-7xl px-6 md:px-8">
          <div className="rounded-[30px] border border-slate-200 bg-white p-8 shadow-sm">
            <h2 className="text-3xl font-extrabold text-slate-950 md:text-4xl">
              Ventilación industrial para ambientes más funcionales y procesos más estables
            </h2>

            <div className="mt-6 grid gap-8 lg:grid-cols-2">
              <div className="space-y-4 text-base leading-8 text-slate-600">
                <p>
                  La ventilación industrial es importante en entornos donde el
                  movimiento del aire, la extracción y la renovación influyen en
                  las condiciones operativas y en el desempeño del proceso.
                </p>
                <p>
                  Esta categoría ayuda a encontrar una entrada más clara para
                  aplicaciones relacionadas con talleres, áreas técnicas, bodegas
                  y procesos que requieren una gestión más eficiente del aire.
                </p>
              </div>
              ...
              <div className="space-y-4 text-base leading-8 text-slate-600">
                ...
                <p>
                  Si buscas soluciones de ventilación industrial en Colombia para
                  tu operación, este punto de entrada facilita una conversación
                  comercial más clara y una mejor identificación de la necesidad.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
              <div className="max-w-3xl">
                ...
                <h2 className="mt-4 text-3xl font-extrabold leading-tight md:text-4xl">
                  Si necesitas una solución de ventilación, empecemos por tu aplicación
                </h2>
